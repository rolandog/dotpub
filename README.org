...
that subdirectory (using [[https://www.gnu.org/software/stow/manual/stow.html][GNU Stow]]).
...
#+BEGIN_SRC bash :exports code :eval never :dir ~/.local/share/dotfiles/pub :wrap SRC text
...
#+name: tree-overview
#+BEGIN_SRC bash :exports results :results output :cache yes :dir ~/.local/share/dotfiles/pub :wrap SRC text
  tree \
    -adlnF  \
    -I '.git|etc|git|ssh'  \
    -L 3  \
...
#+RESULTS[2f96629f6b3716475f3de7e7545880e293be474c]: tree-overview
#+begin_SRC text
